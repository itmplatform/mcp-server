...
export function registerReferenceDataTools(server: McpServer, clients: Clients) {
  server.registerTool(
    'get_reference_data',
    {
      description: 'Get reference data lists (statuses, types, priorities) for any entity. Useful for understanding valid values when filtering or interpreting data. Available entities: projectstatuses, gettaskstatuses, gettasktypes, gettaskpriorities, getprojecttypes, projectpriorities, riskstatuses, risktypes, issuestatuses, issuetypes, purchasestatuses, purchasetypes, revenuestatuses.',
      inputSchema: {
