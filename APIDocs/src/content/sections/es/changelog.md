...
**Notas:**
- El usuario debe estar ya asignado a la tarea. Al publicarse esta versión, crear asignaciones quedaba fuera del alcance de MCP; desde v1.0.17, `create_task`/`update_task` asignan usuarios con `TaskManagers`/`TaskMembers`. Descubra los asignados con `get_task_effort` o `search_users`.
