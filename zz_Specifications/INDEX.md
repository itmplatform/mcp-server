...
| [done/SPEC_MCP_TIME_ENTRY_TOOLS.md](done/SPEC_MCP_TIME_ENTRY_TOOLS.md) | Delegated actuals (`log_time_entry`): decision record + guarded design (HS 11634, 11710) | Done (v1.0.18, stage-verified 2026-08-06; prod deploy pending, requires the ITM.Web token fix + sproc) |
| [done/SPEC_MCP_PROJECT_PROGRESS_TOOLS.md](done/SPEC_MCP_PROJECT_PROGRESS_TOOLS.md) | Project-level Seguimiento: `create_project_progress`, `update_project_progress`, entries in `get_project_progress` (HS 11761) | Done (v1.0.18, stage-verified 2026-08-06; prod deploy pending, requires the ITM.Web token fix + sproc) |
